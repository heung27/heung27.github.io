...
| **저장 형식**                   | text                                                         | Object                                      |
| **만료 시점**                   | 쿠키 저장시 설정 <br />(브라우저가 종료되어도 만료시점이 지나지<br />않으면 자동삭제되지 않음) | 브라우저 종료시 삭제<br /> (기간 지정 가능) |
| **사용하는 자원<br />(리소스)** | 클라이언트 리소스                                            | 웹 서버 리소스                              |
| **용량 제한**                   | 총 300개 하나의 도메인 당 20개<br />하나의 쿠키 당 4KB(=4096byte) | 서버가 허용하는 한 용량제한 없음            |
